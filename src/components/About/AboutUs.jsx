          ...
          <div className="w-full text-center space-y-8 lg:w-1/2 lg:text-left">
            <div className="space-y-3">
              ...
              <h2 className="text-4xl font-serif font-medium leading-lose text-slate-900 md:text-5xl lg:text-6xl">
                ...
                <span className="italic text-orange-600 text-3xl md:text-5xl">
                  Travel Experiences Across India
                </span>
              </h2>

              <p className="mx-auto max-w-xl text-lg leading-relaxed text-slate-600 lg:mx-0">
                At YatraKaroTravels, we believe travel is about discovery,
                connection, and lifelong memories. Based in Rajasthan, we
                specialize in crafting thoughtfully curated journeys that blend
                culture, comfort, adventure, and authenticity — helping
                travelers explore India in its true spirit.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-8 border-y border-slate-100 py-8 text-left sm:grid-cols-2">
              <div className="flex flex-col items-center lg:items-start">
                ...
                <p className="mt-1 text-center text-sm text-slate-500 lg:text-left">
                  Skilled local professionals who design seamless journeys and
                  uncover the true essence of every destination.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center lg:items-start">
                ...
                <h4 className="font-bold text-slate-900">Responsible Travel</h4>
                <p className="mt-1 text-center text-sm text-slate-500 lg:text-left">
                  We promote eco-conscious practices and sustainable tourism to
                  protect nature and preserve cultural heritage.
                </p>
              </div>
            </div>
